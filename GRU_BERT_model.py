...
class GRUBERT(nn.Module):
    def __init__(self, args):
        ...
        # GRU layer added here
        self.gru = nn.GRU(input_size=self.hidden, hidden_size=self.hidden, num_layers=1, batch_first=True)
    ...
    def forward(self, sequence):
        ...
        # Pass through GRU (temporal learning)
        x, _ = self.gru(x)
        mask = None
